...
== Installation ==
The most powerful spam prevention for WordPress: 50+ spam blocking settings, dianostic testing, log reports, and much more. Go to *Plugins > Add New* from your WP admin menu, search for Stop Spammers, install, and activate.
OR
